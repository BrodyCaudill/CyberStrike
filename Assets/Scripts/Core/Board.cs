...
namespace HiveCore
{
    public partial class Board
    {
        ...
        public Board()
        {
            ...
            {
                { Player.Black, new MoveHistory(2) },
                { Player.White, new MoveHistory(2) }
            };
        }
        ...
        public bool IsAlmostDraw() => (HistoryHeuristicPurposes[Player.Black].RepeatedForDraw() && HistoryHeuristicPurposes[Player.White].RepeatedForDraw());
